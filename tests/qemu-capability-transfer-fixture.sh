...
LEANOS/22 OFFER subject=1 address-space=1 origin=cpl3 source-handle=196608 transfer-endpoint=196608 child=6 parent=3 rights=send sealed=1 installed=0 payload0=51966 payload1=48879 control=2099457 value=0 result=PASS
LEANOS/22 DISPATCH subject=2 address-space=2 source=kernel-owned-context result=PASS
LEANOS/22 ENTER subject=2 address-space=2 origin=cpl3 context=fresh result=PASS
LEANOS/22 SEALED-DENIAL subject=2 handle=393219 operation=send authorized=0 reason=not-installed state=unchanged control=4655361 value=0 result=PASS
LEANOS/22 ACCEPT subject=2 address-space=2 origin=cpl3 transfer-endpoint=196608 destination-slot=3 child=6 generation=6 handle=393219 sealed=0 installed=1 exactly-once=1 control=2165249 value=393219 result=PASS
LEANOS/22 DELEGATED-SEND subject=2 handle=393219 endpoint=3 payload0=41332 payload1=45428 right=send authorized=1 mailbox=filled control=4730625 value=0 result=PASS
LEANOS/22 EXCESS-RIGHT-DENIAL subject=2 handle=393219 operation=receive authorized=0 reason=rights state=unchanged mailbox=filled control=4796161 value=0 result=PASS
...
case "$mode" in
  success) ;;
  payload-authority)
    rewrite_log 's/source-handle=196608/source-handle=51966/' ;;
  rights-widened)
  ...
  state-splice)
    rewrite_log '/^LEANOS\/22 SEALED-DENIAL /s/control=4655361/control=4655617/' ;;
  missing)
